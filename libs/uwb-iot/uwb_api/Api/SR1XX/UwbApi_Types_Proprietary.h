...
typedef enum vendorAppConfig
{
    ...
    */
     ...
     * When this config is set to 0x00 or 0x01 then ANTENNAS_CONFIGURATION_RX Mode 0 or Mode 1 is applicable.
     * When this config is set to 0x02 then ANTENNAS_CONFIGURATION_RX mode 5 or 6 are recommended to configure.
     *
     * Note:
     *  1.	When this config is set to 0x00/0x01 and  configured antenna mode is 2/3/4/5/6 then UWBS shall report  reason code ERROR_INVALID_ANTENNA_CFG (0x80) in SESSION_STATUS_NTF.
     *  2.	When this config is set to 0x02 and configured antenna mode  0/1 then same configuration will be used in each RR.
     *  3.	When this config is set to 0x02 and configured antenna mode is 2/3/4 then UWBS shall report  reason code ERROR_INVALID_ANTENNA_CFG (0x80) in SESSION_STATUS_NTF.
     *
    */
